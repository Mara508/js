...
//     document.write(`Name - ${simpsons[i].name}, surname - ${simpsons[i].surname}, age - ${simpsons[i].age}  `);
//     document.write(`<br>Info - ${simpsons[i].info}`);
//     document.write(`<br><img src=${simpsons[i].photo} alt="${simpsons[i].photo}"><br><br>`);
// }
// document.write(`</div>`);
...
//     document.write(`<div>`);
//     document.write(`<p style="width: 400px;" >${simpsons[i].info}</p>`);
//     document.write(`</div>`);
//     document.write(`<img  style="height: 400px; margin-left: 10px;" src=${simpsons[i].photo} alt="${simpsons[i].photo}">`);
//     document.write(`</div>`);
// }
// document.write(`</div>`);
...
//     document.write(`<img  style="height: 400px;" src=${products[i].image} alt="" class="product-image">`)
//     document.write(`</div>`);
// }
// document.write(`</div>`);
